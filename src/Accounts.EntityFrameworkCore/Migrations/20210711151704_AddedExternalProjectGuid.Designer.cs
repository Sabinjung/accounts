...
namespace Accounts.Migrations
{
    ...
    [Migration("20210711151704_AddedExternalProjectGuid")]
    partial class AddedExternalProjectGuid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounts.Models.ExpenseType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Accounts.Models.HourLogEntry", b =>
                {
                    ...
                    b.ToTable("HourLogEntries");
                });

            modelBuilder.Entity("Accounts.Models.IntuitWebhookLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("IntuitWebhookLogs");
                });

            modelBuilder.Entity("Accounts.Models.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Accounts.Models.InvoiceCycle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Accounts.Models.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Accounts.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime?>("InvoiceCycleStartDt");
            ...
            modelBuilder.Entity("Accounts.Models.Term", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Accounts.Models.TimesheetPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Accounts.Models.TimesheetStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Accounts.Models.Note", b =>
                {
                    b.HasOne("Accounts.Models.EndClient")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("Accounts.Models.Project", b =>
                {
                    ...
                    b.HasOne("Accounts.Models.PaymentMethod")
                        .WithMany("Projects")
                        .HasForeignKey("PaymentMethodId");
            ...
            modelBuilder.Entity("Accounts.Models.Timesheet", b =>
                {
                    ...
                    b.HasOne("Accounts.Models.TimesheetStatus", "Status")
                        .WithMany()
