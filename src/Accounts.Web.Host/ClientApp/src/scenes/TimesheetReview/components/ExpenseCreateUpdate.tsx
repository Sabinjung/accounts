  ...
  return (
    <React.Fragment>
      <Form {...formItemLayout}>
        <Form.Item label="ExpenseType">
          {getFieldDecorator('expenseTypeId', {
            ...
            <EntityPicker
              url="/api/services/app/ExpenseType/Search"
              placeholder="Type"
        ...
        <Form.Item label="Comment">
          {getFieldDecorator('comment')(<TextArea rows={2} placeholder="Comment..." />)}
        </Form.Item>
      </Form>
      ...
      >
        ...
        <Button type='danger' style={{ marginLeft: 8 }} onClick={() => { onClose() }}>Cancel</Button>
      </div>
    </React.Fragment >
  );
};
